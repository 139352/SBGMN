...
parser.add_argument('--dataset_name', type=str, default='senate1to10-1')
...
class SBGNN(nn.Module):
    ...
    def multi_view(self, emb_all):
        ...
        left_edge_index = left_edge_index.to(args.device)
        ...
        right_edge_index = right_edge_index.to(args.device)
...
def run():
    ...
    # plt.plot(args.epoch, auc_trainvalues, marker='o', linestyle='-')
    # plt.title('train-AUC Curve Over Epochs')
    # plt.xlabel('Epochs')
    ...
    #
    # plt.figure(figsize=(8, 5))
    # plt.plot(args.epoch, auc_valvalues, marker='o', linestyle='-')
    # plt.title('val-AUC Curve Over Epochs')
    # plt.xlabel('Epochs')
    # plt.ylabel('val-AUC')
    # plt.grid(True)
    # plt.show()
    #
    # plt.figure(figsize=(8, 5))
    # plt.plot(args.epoch, auc_testvalues, marker='o', linestyle='-')
    # plt.title('test-AUC Curve Over Epochs')
    # plt.xlabel('Epochs')
    # plt.ylabel('test-AUC')
    # plt.grid(True)
    # plt.show()
