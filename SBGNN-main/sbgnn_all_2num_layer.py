...
parser.add_argument('--dataset_name', type=str, default='ml-1m-2')
...
class SBGNN(nn.Module):
    def __init__(self, edgelists,
                 dataset_name=args.dataset_name, layer_num=2, emb_size_a=32, emb_size_b=32):
    ...
    def multi_gnn_loss(self, embedding_a, embedding_b, embedding_a2, embedding_b2):
        ...
        loss = 0.4 * loss_1 + 0.6 * adjacency_loss
        # loss = loss_1
